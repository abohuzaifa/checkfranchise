...
import 'package:franchise_app/screens/forgot_password/forgot_password_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child: CircularProgressIndicator(),
        ...
        :   Column(
            children: [
              Container(
                margin:  EdgeInsets.only(top: h*0.19,left: w*0.04,right: w*0.04),
                alignment: Alignment.center,
                child: Stack(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  ...
                                  offset: Offset(0, 2), // Shadow appears at the bottom
                                ),
                              ],
                            ),
                            height: h*0.06,
                            margin:  EdgeInsets.only(top: h*0.035,left: w*0.05,right: w*0.05),
                            padding:  EdgeInsets.only(top: h*0.005,bottom: h*0.005,left: w*0.05,right: w*0.05),
                            child: Row(
                              children: [
                                // Email Icon
                                Image.asset(
                          ...
                          InkWell(
                            onTap: () {
                              if (emailController
                                ...
                                forgotPasswordController.forgotPasswordFunction(
                            ...
                            child: Container(
                              height: h*0.052,
                              width: w*0.35,
                              margin: EdgeInsets.only(top: h*0.045,bottom: h*0.04),
                              alignment: Alignment.center,
                              decoration: BoxDecoration(
