...
class PreviousBranchesShowAllScreen extends StatefulWidget {
  const PreviousBranchesShowAllScreen({super.key});

  @override
  State<PreviousBranchesShowAllScreen> createState() => _PreviousBranchesShowAllScreenState();
}

class _PreviousBranchesShowAllScreenState extends State<PreviousBranchesShowAllScreen> {
  String? selectedCity;
  ...
  void initState() {
    ...
    super.initState();
    previousReportsController.previousReportsFunction();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
          () => previousReportsController.isloading.value
          ? Container(
        height: h,
        width: w,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemCount: previousReportsController.preReportData.length,
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                print("ID : ${ previousReportsController.preReportData[index]['branch']['id'].toString()}");
                                branchId.value =  previousReportsController.preReportData[index]['branch']['id'].toString();
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child:
                                          CachedNetworkImage(
                                            imageUrl: "${AppConstants.branchImgUrl}${previousReportsController.preReportData[index]['branch']['header_image']}",
                                            fit: BoxFit.fill,
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          MainAxisAlignment
                                              .spaceBetween,
                                          children: [
                                            Text(previousReportsController
